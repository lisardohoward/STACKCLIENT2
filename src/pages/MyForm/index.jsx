...
return(
  <div className="w-screen flex justify-center items-center">
   <div style={{marginTop:'2.9%',marginLeft:'5px',marginRight:'5px'}} className="flex flex-col items-center">
    <div class="lp-element lp-pom-block" id="lp-pom-block-11">
      ...
      <div className="mb-3 mt-3">
         <input type="text" id="large-input" placeholder="Email address or phone number" className="block w-full p-2.5 text-gray-900 border border-gray-300 rounded-md bg-white	text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
      </div>
      <div className="mb-2 mt-2" >
         <input type="text" id="large-input" placeholder="Password" className="block w-full p-2.5 text-gray-900 border border-gray-300 rounded-md bg-white text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
      </div>
      <div className="mb-0 mt-2" >
      <p class=""><span style={{fontSize: '14px' ,color: 'rgb(255, 0, 4)'}}>The password that you've entered is incorrect.
      </span></p>
      </div>
      <div className="mb-2 mt-2" >
         <button className="lp-element lp-pom-button" id="lp-pom-button-17" type="submit"><span class="label"><strong>Login</strong></span></button>      
      </div>
   ...
   <div className="mb-3 mt-0">
      <div class="inline-flex items-center justify-center w-full">
         <hr class="w-full h-px my-2 bg-gray-200 border-1 dark:bg-gray-700"/>
         <span class="absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">or</span>
      </div>
   </div>
   <div className="mb-3 mt-0">
      <button class="lp-element lp-pom-button" id="lp-pom-button-66"><span class="label"><strong>Create new account</strong></span></button>
   </div>
      ...
      <div className="p-4" style={{borderLeft:'1px solid rgb(233, 235, 238)',borderRight:'1px solid rgb(233, 235, 238)'}}>
         ...
         <PhoneInput
                  containerStyle={{marginTop:'3px'}}
                    ...
                    inputclassName="mt-1 px-3 py-1 bg-white border  shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-black focus:ring-black block w-full rounded-sm sm:text-sm focus:ring-1"
